...
#define  IFX_CFG_CPUCSTART_BMI00_NOT_NEEDED

//#define IFX_CFG_CPU_CSTART_ENABLE_TRICORE0_DCACHE (0) // Data cache for Cpu0 is disabled
//#define IFX_CFG_CPU_CSTART_ENABLE_TRICORE1_DCACHE (0) // Data cache for Cpu0 is disabled
//#define IFX_CFG_CPU_CSTART_ENABLE_TRICORE2_DCACHE (0) // Data cache for Cpu0 is disabled
