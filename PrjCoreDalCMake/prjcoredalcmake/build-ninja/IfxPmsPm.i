# 1 "D:/PrjCoreDalCMake/prjcoredalcmake/deps/dal/tc36x/Libraries/iLLD/TC36A/Tricore/Pms/Std/IfxPmsPm.c"
...
# 1 "<command-line>" 2
# 1 "D:/PrjCoreDalCMake/prjcoredalcmake/deps/dal/tc36x/Libraries/iLLD/TC36A/Tricore/Pms/Std/IfxPmsPm.c"
# 46 "D:/PrjCoreDalCMake/prjcoredalcmake/deps/dal/tc36x/Libraries/iLLD/TC36A/Tricore/Pms/Std/IfxPmsPm.c"
...
# 65 "D:/PrjCoreDalCMake/prjcoredalcmake/deps/dal/tc36x/Libraries/iLLD/TC36A/Tricore/Scu/Std/IfxScuWdt.h" 2
...
# 69 "D:/PrjCoreDalCMake/prjcoredalcmake/deps/dal/tc36x/Libraries/iLLD/TC36A/Tricore/Scu/Std/IfxScuWdt.h" 2
...
# 66 "D:/PrjCoreDalCMake/prjcoredalcmake/deps/dal/tc36x/Libraries/iLLD/TC36A/Tricore/Pms/Std/IfxPmsPm.h" 2
...
# 47 "D:/PrjCoreDalCMake/prjcoredalcmake/deps/dal/tc36x/Libraries/iLLD/TC36A/Tricore/Pms/Std/IfxPmsPm.c" 2
...
void IfxPmsPm_setStandbyMode(Ifx_PMS *pms, IfxPmsPm_WakeupConfig *config, IfxPmsPm_RequestPowerMode powerMode)
{
    ...
    uint16 safetyWdtPw = IfxScuWdt_getSafetyWatchdogPassword();
    {
        ...
        IfxScuWdt_clearCpuEndinit(cpuWdtPw);
        smuTrapEnable = (*(volatile Ifx_SCU_TRAPDIS0*)0xF0036130u).B.CPU0SMUT;
        (*(volatile Ifx_SCU_TRAPDIS0*)0xF0036130u).B.CPU0SMUT = 1U;
        IfxScuWdt_setCpuEndinit(cpuWdtPw);
    }
...

    {
        ...
        (*(volatile Ifx_SMU_KEYS*)0xF0036834u).U = (uint32)0x000000bc;

        ((*(Ifx_SMU*)0xF0036800u)).AGCF[alarmGroup][0].U = (((*(Ifx_SMU*)0xF0036800u)).AGCF[alarmGroup][0].U & ~alarmMask);
        ((*(Ifx_SMU*)0xF0036800u)).AGCF[alarmGroup][1].U = (((*(Ifx_SMU*)0xF0036800u)).AGCF[alarmGroup][1].U & ~alarmMask);
        ((*(Ifx_SMU*)0xF0036800u)).AGCF[alarmGroup][2].U = (((*(Ifx_SMU*)0xF0036800u)).AGCF[alarmGroup][2].U & ~alarmMask);


        (*(volatile Ifx_SMU_KEYS*)0xF0036834u).U = (uint32)0U;
    }

    (*(volatile Ifx_SCU_CCUCON0*)0xF0036030u).B.CLKSEL = IfxScu_CCUCON0_CLKSEL_fBack;


    (*(volatile Ifx_SCU_CCUCON0*)0xF0036030u).B.UP = 1U;


    for (wait_cycles = 0; wait_cycles < 100; wait_cycles++)
    {
        Ifx__nop();
    }


    (*(volatile Ifx_SCU_SYSPLLCON0*)0xF0036018u).B.PLLPWD = 0U;
    (*(volatile Ifx_SCU_PERPLLCON0*)0xF0036028u).B.PLLPWD = 0U;


    (*(volatile Ifx_SCU_OSCCON*)0xF0036010u).B.MODE = 3U;





    (*(volatile Ifx_SCU_PMSWCR1*)0xF00360E8u).B.IRADIS = 1U;


    (*(volatile Ifx_SCU_PMSWCR1*)0xF00360E8u).B.STBYEVEN = 1U;
    (*(volatile Ifx_SCU_PMSWCR1*)0xF00360E8u).B.STBYEV = 0U;
...

    {
        ...
        (*(volatile Ifx_SCU_TRAPDIS0*)0xF0036130u).B.CPU0SMUT = smuTrapEnable;
        IfxScuWdt_setCpuEndinit(cpuWdtPw);
    }
...
boolean IfxPmsPm_setCoreMode(IfxCpu_ResourceCpu cpuIndex, IfxCpu_CoreMode mode)
{
    ...
    retValue = ((mode == IfxCpu_CoreMode_halt) || (mode == IfxCpu_CoreMode_stby)) ? (0u) : (1u);
    ...
    if (retValue == (1u))
    {
        ...
        if (IfxCpu_getCoreIndex() != cpuIndex)
        {
            ...
            {
            case 0:
                ((*(Ifx_SCU*)0xF0036000u)).PMCSR0.B.REQSLP = reqSleep;
                break;
            case 1:
                ((*(Ifx_SCU*)0xF0036000u)).PMCSR1.B.REQSLP = reqSleep;
                break;
            }
...
void IfxPmsPm_configureSupplyMonitoring(Ifx_PMS *pms, IfxPmsPm_VoltageSource source, IfxPmsPm_ThresholdEvent event, IfxPmsPm_RampingMode mode)
{
    ...
    pms->MONCTRL.U = (pms->MONCTRL.U & ~mask) | ((mode & 0x3) << (source + event));
    IfxScuWdt_setSafetyEndinit(safetyWdtPw);
}
...
void IfxPmsPm_initStandbyConfig(IfxPmsPm_StandbyConfig *standbyConfig)
{
    ...
    standbyConfig->enableStandbyOnVextRampDown = (0u);
    standbyConfig->enableStandbyOnVddRampDown = (0u);
    ...
    standbyConfig->enableWakeupOnEsr0 = (0u);
    standbyConfig->enableWakeupOnEsr1 = (0u);
    standbyConfig->enableWakeupOnPinA = (0u);
    standbyConfig->enableWakeupOnPinB = (0u);
    standbyConfig->enableWakeupOnPorst = (1u);
    standbyConfig->enableWakeupOnScr = (0u);
    standbyConfig->enableWakeupOnPower = (0u);
    standbyConfig->enableWakeupOnTimer = (0u);
    standbyConfig->wutClock = IfxPmsPm_WutClock_70kHz;
    standbyConfig->useWutStandbyAutoStopMode = (0u);
...
void IfxPmsPm_startStandbySequenceInFlash(IfxPmsPm_StandbyConfig *standbyConfig, const IfxScuCcu_Config *clockConfig)
{
    ...
    (*(volatile Ifx_PMS_PMSWSTATCLR*)0xF02480E8u).U = ((*(volatile Ifx_PMS_PMSWSTATCLR*)0xF02480E8u).U | 0xEFFF);
    ...
    {
        pmswcr1.U = (*(volatile Ifx_SCU_PMSWCR1*)0xF00360E8u).U;
        pmswcr1.B.STBYEVEN = 1;
        pmswcr1.B.STBYEV = standbyConfig->trigger;
        (*(volatile Ifx_SCU_PMSWCR1*)0xF00360E8u).U = pmswcr1.U;
    }

    if (standbyConfig->enableStandbyOnVextRampDown)
    {
        (*(volatile Ifx_PMS_PMSWCR0*)0xF02480B4u).B.VEXTSTBYEN = 1;
    }

    if (standbyConfig->enableStandbyOnVddRampDown)
    {
        (*(volatile Ifx_PMS_PMSWCR0*)0xF02480B4u).B.VDDSTBYEN = 1;
    }
    ...
    if (standbyConfig->enableStandbyOnVextRampDown)
    {
        IfxPmsEvr_setSecondaryUnderVoltageThresholdMv(&((*(Ifx_PMS*)0xF0248000u)), standbyConfig->vextUnderVoltageThresholdLevel, IfxPmsEvr_SupplyMode_swd);
    }

    if (standbyConfig->enableStandbyOnVddRampDown)
    {
        IfxPmsEvr_setSecondaryUnderVoltageThresholdMv(&((*(Ifx_PMS*)0xF0248000u)), standbyConfig->vddUnderVoltageThresholdLevel, IfxPmsEvr_SupplyMode_evrc);
    }
        ...
        {
            {
                ...
                (*(volatile Ifx_SCU_SYSPLLCON1*)0xF003601Cu).B.K2DIV = pllThrottleConfig.pllSteps[pllStepsCount - 1].k2Step;
                IfxScuWdt_setSafetyEndinitInline(endinitSfty_pw);
...
void IfxPmsPm_continueStandbySequenceInRAM(IfxPmsPm_StandbyConfig *standbyConfig, const IfxScuCcu_Config *clockConfig)
{
    ...
    (*(volatile Ifx_DMU_HF_PCONTROL*)0xF8040064u).B.SLEEP = 0x3;


    while (!(*(volatile Ifx_DMU_HF_PSTATUS*)0xF8040060u).B.SLEEP)
    {}
    ...
    (*(volatile Ifx_SCU_CCUCON0*)0xF0036030u).B.LPDIV = 0x4;
    ...
    cmdStdby.U = (*(volatile Ifx_PMS_CMD_STDBY*)0xF024819Cu).U;
    cmdStdby.B.SMUEN = 0;
    cmdStdby.B.BITPROT = 1;
    (*(volatile Ifx_PMS_CMD_STDBY*)0xF024819Cu).U = cmdStdby.U;


    (*(volatile Ifx_SCU_PMSWCR1*)0xF00360E8u).B.IRADIS = 1U;


    ((*(Ifx_SCU*)0xF0036000u)).RSTCON.U = 0U;

    Ifx_PMS_PMSWCR0 pmswcr0;
    pmswcr0.U = (*(volatile Ifx_PMS_PMSWCR0*)0xF02480B4u).U;
    ...
    (*(volatile Ifx_PMS_PMSWCR0*)0xF02480B4u).U = pmswcr0.U;


    Ifx_PMS_PMSWCR5 pmswcr5;
    pmswcr5.U = (*(volatile Ifx_PMS_PMSWCR5*)0xF02480C8u).U;
    pmswcr5.B.BPTRISTREQ = 1;
    pmswcr5.B.TRISTREQ = 1;
    pmswcr5.B.BPTRISTREQ = 1;
    pmswcr5.B.ESR0TRIST = 1;
    (*(volatile Ifx_PMS_PMSWCR5*)0xF02480C8u).U = pmswcr5.U;



    Ifx_PMS_PMSWCR4 pmswcr4;
    pmswcr4.U = (*(volatile Ifx_PMS_PMSWCR4*)0xF02480C4u).U;
    ...
    (*(volatile Ifx_PMS_PMSWCR4*)0xF02480C4u).U = pmswcr4.U;

    IfxScuWdt_setSafetyEndinitInline(endinitSfty_pw);

    cpuPassword = IfxScuWdt_getCpuWatchdogPasswordInline(&((*(Ifx_SCU*)0xF0036000u)).WDTCPU[standbyConfig->masterCpu]);

    if (standbyConfig->trigger == IfxPmsPm_StandbyTriggerMode_software)
    {
        IfxScuWdt_clearCpuEndinitInline(&((*(Ifx_SCU*)0xF0036000u)).WDTCPU[standbyConfig->masterCpu], cpuPassword);

        switch (standbyConfig->masterCpu)
        {
        case IfxCpu_ResourceCpu_0: (*(volatile Ifx_SCU_PMCSR0*)0xF00360C8u).B.REQSLP = 0x3;
            break;
        case IfxCpu_ResourceCpu_1: (*(volatile Ifx_SCU_PMCSR1*)0xF00360CCu).B.REQSLP = 0x3;
            break;
        default:
    ...
    IfxScuWdt_setCpuEndinitInline(&((*(Ifx_SCU*)0xF0036000u)).WDTCPU[standbyConfig->masterCpu], cpuPassword);
}
...
void IfxPmsPm_configureWakeup(IfxPmsPm_StandbyConfig *standbyConfig)
{
    ...
    Ifx_PMS_PMSWCR3 pmswcr3;
    pmswcr0.U = (*(volatile Ifx_PMS_PMSWCR0*)0xF02480B4u).U;
    pmswcr3.U = (*(volatile Ifx_PMS_PMSWCR3*)0xF02480C0u).U;
    ...
    if ((standbyConfig->enableWakeupOnTimer == (1u)) && (standbyConfig->useWutStandbyAutoStopMode == (1u)))
    {
    ...
    IfxScuWdt_clearSafetyEndinitInline(endinitSfty_pw);
    (*(volatile Ifx_PMS_PMSWCR0*)0xF02480B4u).U = pmswcr0.U;
    (*(volatile Ifx_PMS_PMSWCR3*)0xF02480C0u).U = pmswcr3.U;
    IfxScuWdt_setSafetyEndinitInline(endinitSfty_pw);
}
...
{
    sleepConfig->mcanEnabled = (0u);
    sleepConfig->mcanClockSource = IfxScuCcu_Fsource_0;
    sleepConfig->asclinEnabled = (0u);
    sleepConfig->asclinClockSource = IfxScuCcu_Fsource_0;
    sleepConfig->gpt12Enabled = (0u);
    sleepConfig->ccu6Enabled = (0u);
    sleepConfig->qspiEnabled = (0u);
    sleepConfig->qspiClockSource = IfxScuCcu_Fsource_0;
    sleepConfig->gethEnabled = (0u);
    sleepConfig->i2cEnabled = (0u);
    sleepConfig->gtmEnabled = (0u);
    sleepConfig->stmEnabled = (0u);
}
...
void IfxPmsPm_startSleepSequenceinFlash(IfxPmsPm_SleepConfig *sleepConfig, IfxScuCcu_Config *clockConfig)
{
    ...
    Ifx_SCU_PERPLLCON0 perpllcon0;
    syspllcon0.U = (*(volatile Ifx_SCU_SYSPLLCON0*)0xF0036018u).U;
    perpllcon0.U = (*(volatile Ifx_SCU_PERPLLCON0*)0xF0036028u).U;

    syspllcon0.B.PLLPWD = 0;
    perpllcon0.B.PLLPWD = 0;
    ...
    (*(volatile Ifx_SCU_SYSPLLCON0*)0xF0036018u).U = syspllcon0.U;
    (*(volatile Ifx_SCU_PERPLLCON0*)0xF0036028u).U = perpllcon0.U;

    (*(volatile Ifx_SCU_CCUCON0*)0xF0036030u).B.LPDIV = 0x4;
    (*(volatile Ifx_SCU_CCUCON0*)0xF0036030u).B.UP = 1;
    (*(volatile Ifx_SCU_CCUCON1*)0xF0036034u).B.CLKSELMCAN = sleepConfig->mcanClockSource;
    (*(volatile Ifx_SCU_CCUCON2*)0xF0036040u).B.CLKSELASCLINS = sleepConfig->asclinClockSource;
    (*(volatile Ifx_SCU_CCUCON1*)0xF0036034u).B.CLKSELQSPI = sleepConfig->qspiClockSource;
...
void IfxPmsPm_continueSleepSequenceInRAM(IfxPmsPm_SleepConfig *sleepConfig)
{
    ...
    (*(volatile Ifx_DMU_HF_PCONTROL*)0xF8040064u).B.SLEEP = 3;


    while (!(*(volatile Ifx_DMU_HF_PSTATUS*)0xF8040060u).B.SLEEP)
    {}

    endinit_pw = IfxScuWdt_getCpuWatchdogPasswordInline(&((*(Ifx_SCU*)0xF0036000u)).WDTCPU[sleepConfig->masterCpu]);

    IfxScuWdt_clearCpuEndinitInline(&((*(Ifx_SCU*)0xF0036000u)).WDTCPU[IfxCpu_getCoreIndex()], endinit_pw);

    switch (sleepConfig->masterCpu)
    {
    case IfxCpu_ResourceCpu_0: (*(volatile Ifx_SCU_PMCSR0*)0xF00360C8u).B.REQSLP = 0x2;

        while ((*(volatile Ifx_SCU_PMCSR0*)0xF00360C8u).B.PMST == 0x4)
        {}

        break;

    case IfxCpu_ResourceCpu_1: (*(volatile Ifx_SCU_PMCSR1*)0xF00360CCu).B.REQSLP = 0x2;

        while ((*(volatile Ifx_SCU_PMCSR1*)0xF00360CCu).B.PMST == 0x4)
        {}
    ...
    IfxScuWdt_setCpuEndinitInline(&((*(Ifx_SCU*)0xF0036000u)).WDTCPU[sleepConfig->masterCpu], endinit_pw);
}
...
void IfxPmsPm_initiateWakeup(IfxScuCcu_Config *clockConfig)
{
    ...
    (*(volatile Ifx_DMU_HF_PCONTROL*)0xF8040064u).B.SLEEP = 0;
...
{
    loadJumpConfig->enableLoadJumpTimer = (1u);
    loadJumpConfig->enableLoadJumpTimerOverflowFlag = (1u);
    loadJumpConfig->enableLoadJumpTimerOverflowInterrupt = (0u);
}
...
void IfxPmsPm_initAndRequestLoadJump(IfxPmsPm_LoadJumpConfig *loadJumpConfig)
{
    ...
    (*(volatile Ifx_SCU_PMTRCSR0*)0xF0036198u).B.LJTEN = loadJumpConfig->enableLoadJumpTimer;
    (*(volatile Ifx_SCU_PMTRCSR0*)0xF0036198u).B.LJTOVEN = loadJumpConfig->enableLoadJumpTimerOverflowFlag;
    (*(volatile Ifx_SCU_PMTRCSR0*)0xF0036198u).B.LJTOVIEN = loadJumpConfig->enableLoadJumpTimerOverflowInterrupt;
    Ifx__dsync();
    (*(volatile Ifx_SCU_PMTRCSR2*)0xF00361A0u).B.LDJMPREQ = 1U;
    IfxScuWdt_setSafetyEndinit(safetyWdtPw);
}
...
void IfxPmsPm_initVoltageDroopConfig(IfxPmsPm_VoltageDroopConfig *voltageDroopConfig)
{
    ...
    voltageDroopConfig->enableVoltageDroopTimer = (1u);

    voltageDroopConfig->enableVoltageDroopTimerOverflowFlag = (1u);

    voltageDroopConfig->enableVoltageDroopTimerOverflowInterrupt = (0u);
...
void IfxPmsPm_initAndRequestVoltageDroop(IfxPmsPm_VoltageDroopConfig *voltageDroopConfig)
{
    ...
    (*(volatile Ifx_SCU_PMTRCSR0*)0xF0036198u).B.VDTEN = voltageDroopConfig->enableVoltageDroopTimer;
    (*(volatile Ifx_SCU_PMTRCSR0*)0xF0036198u).B.VDTOVEN = voltageDroopConfig->enableVoltageDroopTimerOverflowFlag;
    (*(volatile Ifx_SCU_PMTRCSR0*)0xF0036198u).B.VDTOVIEN = voltageDroopConfig->enableVoltageDroopTimerOverflowInterrupt;
    (*(volatile Ifx_SCU_PMTRCSR0*)0xF0036198u).B.SDSTEP = voltageDroopConfig->droopStep;
    Ifx__dsync();
    (*(volatile Ifx_SCU_PMTRCSR3*)0xF00361A4u).B.VDROOPREQ = voltageDroopConfig->droopRequestType;
    IfxScuWdt_setSafetyEndinit(safetyWdtPw);
}
