...
core0_main:
.LFB237:
	.file 1 "D:/PrjCoreDalCMake/prjcoredalcmake/src/Cpu0_Main_tc365.c"
	.loc 1 36 0
	mov.aa	%a14, %SP
.LCFI0:
.LBB4:
...
.LFE237:
	...
	.global	Rte_DataMsgBufferApp1
.section .bss,"aw",@nobits
	.type	Rte_DataMsgBufferApp1, @object
	.size	Rte_DataMsgBufferApp1, 60
Rte_DataMsgBufferApp1:
	.zero	60
.section .text.Rte_Func0,"ax",@progbits
	.align 1
	.global	Rte_Func0
	.type	Rte_Func0, @function
Rte_Func0:
.LFB238:
	.loc 1 55 0
	mov.aa	%a14, %SP
.LCFI1:
	.loc 1 57 0
	movh	%d15, hi:test00.9392
	addi	%d15, %d15, lo:test00.9392
	mov.a	%a15, %d15
	ld.bu	%d15, [%a15]0
	add	%d15, 1
	and	%d15, 255
	movh	%d2, hi:test00.9392
	addi	%d2, %d2, lo:test00.9392
	mov.a	%a15, %d2
	st.b	[%a15]0, %d15
	.loc 1 59 0
	movh	%d15, hi:setEvTest00.9393
	addi	%d15, %d15, lo:setEvTest00.9393
	mov.a	%a15, %d15
	ld.bu	%d15, [%a15]0
	jz	%d15, .L3
	.loc 1 61 0
	movh	%d15, hi:setEvTest00.9393
	addi	%d2, %d15, lo:setEvTest00.9393
	mov	%d15, 0
	mov.a	%a15, %d2
	st.b	[%a15]0, %d15
	.loc 1 62 0
...
.L3:
	...
	ret
.LFE238:
	.size	Rte_Func0, .-Rte_Func0
.section .text.Rte_Func2,"ax",@progbits
	.align 1
	.global	Rte_Func2
	.type	Rte_Func2, @function
Rte_Func2:
.LFB239:
	.loc 1 66 0
	mov.aa	%a14, %SP
.LCFI2:
	.loc 1 68 0
	movh	%d15, hi:test02.9397
	addi	%d15, %d15, lo:test02.9397
	mov.a	%a15, %d15
	ld.bu	%d15, [%a15]0
	add	%d15, 1
	and	%d15, 255
	movh	%d2, hi:test02.9397
	addi	%d2, %d2, lo:test02.9397
	mov.a	%a15, %d2
	st.b	[%a15]0, %d15
	.loc 1 69 0
	ret
.LFE239:
	.size	Rte_Func2, .-Rte_Func2
.section .text.Rte_App1ToApp2MsgSendNotif,"ax",@progbits
	.align 1
	.global	Rte_App1ToApp2MsgSendNotif
	.type	Rte_App1ToApp2MsgSendNotif, @function
Rte_App1ToApp2MsgSendNotif:
.LFB240:
	.loc 1 71 0
	mov.aa	%a14, %SP
.LCFI3:
	.loc 1 73 0
	movh	%d15, hi:test03.9401
	addi	%d15, %d15, lo:test03.9401
	mov.a	%a15, %d15
	ld.bu	%d15, [%a15]0
	add	%d15, 1
	and	%d15, 255
	movh	%d2, hi:test03.9401
	addi	%d2, %d2, lo:test03.9401
	mov.a	%a15, %d2
	st.b	[%a15]0, %d15
	.loc 1 74 0
	ret
.LFE240:
	.size	Rte_App1ToApp2MsgSendNotif, .-Rte_App1ToApp2MsgSendNotif
.section .text.Rte_App1ToApp2Msg1ReceiveNotif,"ax",@progbits
	.align 1
	.global	Rte_App1ToApp2Msg1ReceiveNotif
	.type	Rte_App1ToApp2Msg1ReceiveNotif, @function
Rte_App1ToApp2Msg1ReceiveNotif:
.LFB241:
	.loc 1 76 0
	mov.aa	%a14, %SP
.LCFI4:
	.loc 1 78 0
	movh	%d15, hi:test04.9405
	addi	%d15, %d15, lo:test04.9405
	mov.a	%a15, %d15
	ld.bu	%d15, [%a15]0
	add	%d15, 1
	and	%d15, 255
	movh	%d2, hi:test04.9405
	addi	%d2, %d2, lo:test04.9405
	mov.a	%a15, %d2
	st.b	[%a15]0, %d15
	.loc 1 79 0
	ret
.LFE241:
	.size	Rte_App1ToApp2Msg1ReceiveNotif, .-Rte_App1ToApp2Msg1ReceiveNotif
	.local	test00.9392
.section .bss,"aw",@nobits
	.align 0
	.type		 test00.9392,@object
	.size		 test00.9392,1
test00.9392:
	.space	1
	.local	setEvTest00.9393
	.align 0
	.type		 setEvTest00.9393,@object
	.size		 setEvTest00.9393,1
setEvTest00.9393:
	.space	1
	.local	test02.9397
	.align 0
	.type		 test02.9397,@object
	.size		 test02.9397,1
test02.9397:
	.space	1
	.local	test03.9401
	.align 0
	.type		 test03.9401,@object
	.size		 test03.9401,1
test03.9401:
	.space	1
	.local	test04.9405
	.align 0
	.type		 test04.9405,@object
	.size		 test04.9405,1
test04.9405:
	.space	1
...
.Ldebug_info0:
	...
	.byte	0x1
	.string	"D:/PrjCoreDalCMake/prjcoredalcmake/src/Cpu0_Main_tc365.c"
	...
	.uleb128 0xf
	.byte	0x1
	.string	"Rte_App1ToApp2MsgSendNotif"
	.byte	0x1
	.byte	0x46
	.byte	0x1
	.uaword	.LFB240
	...
	.uleb128 0xf
	.byte	0x1
	.string	"Rte_App1ToApp2Msg1ReceiveNotif"
	.byte	0x1
	.byte	0x4b
	.byte	0x1
	.uaword	.LFB241
