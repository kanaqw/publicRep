# 1 "D:/PrjCoreDalCMake/prjcoredalcmake/deps/dal/tc36x/Libraries/iLLD/TC36A/Tricore/Stm/Std/IfxStm.c"
...
# 1 "<command-line>" 2
# 1 "D:/PrjCoreDalCMake/prjcoredalcmake/deps/dal/tc36x/Libraries/iLLD/TC36A/Tricore/Stm/Std/IfxStm.c"
# 46 "D:/PrjCoreDalCMake/prjcoredalcmake/deps/dal/tc36x/Libraries/iLLD/TC36A/Tricore/Stm/Std/IfxStm.c"
...
# 47 "D:/PrjCoreDalCMake/prjcoredalcmake/deps/dal/tc36x/Libraries/iLLD/TC36A/Tricore/Stm/Std/IfxStm.c" 2
...
volatile Ifx_SRC_SRCR *IfxStm_getSrcPointer(Ifx_STM *stm, IfxStm_Comparator comparator)
{
    ...
    return comparator == IfxStm_Comparator_0 ? &((*(Ifx_SRC*)0xF0038000u)).STM.STM[index].SR[0] : &((*(Ifx_SRC*)0xF0038000u)).STM.STM[index].SR[1];
}
...
boolean IfxStm_initCompare(Ifx_STM *stm, const IfxStm_CompareConfig *config)
{
    ...
    if (config->triggerPriority > 0)
    {
        ...
        {
            srcr = &(((*(Ifx_SRC*)0xF0038000u)).STM.STM[index].SR[0]);
        }
        else
        {
            srcr = &(((*(Ifx_SRC*)0xF0038000u)).STM.STM[index].SR[1]);
        }
