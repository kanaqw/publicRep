...
.LFB237:
	.file 1 "D:/PrjCoreDalCMake/prjcoredalcmake/deps/core/Os/FreeRTOS/timers.c"
	.loc 1 234 0
	mov.aa	%a14, %SP
.LCFI0:
	sub.a	%SP, 40
	...
	.loc 1 243 0
	movh	%d15, hi:xTimerQueue
	addi	%d15, %d15, lo:xTimerQueue
	mov.a	%a15, %d15
	ld.w	%d15, [%a15]0
	jz	%d15, .L2
.LBB79:
	...
	ld.w	%d15, [%a14] -20
	st.w	[%SP]0, %d15
	movh	%d15, hi:prvTimerTask
	mov.a	%a15, %d15
	lea	%a4, [%a15] lo:prvTimerTask
	movh	%d15, hi:.LC0
	mov.a	%a15, %d15
	lea	%a5, [%a15] lo:.LC0
	mov	%d4, %d3
	...
	mov.d	%d2, %a2
	movh	%d15, hi:xTimerTaskHandle
	addi	%d15, %d15, lo:xTimerTaskHandle
	mov.a	%a15, %d15
	st.w	[%a15]0, %d2
	.loc 1 260 0
	movh	%d15, hi:xTimerTaskHandle
...
#APP
	# 281 "D:/PrjCoreDalCMake/prjcoredalcmake/deps/core/Os/FreeRTOS/timers.c" 1
	disable
	# 0 "" 2
#NO_APP
.LBB81:
...
#APP
	# 330 "D:/PrjCoreDalCMake/prjcoredalcmake/deps/core/Os/FreeRTOS/timers.c" 1
	disable
	# 0 "" 2
#NO_APP
.LBB87:
...
#APP
	# 336 "D:/PrjCoreDalCMake/prjcoredalcmake/deps/core/Os/FreeRTOS/timers.c" 1
	disable
	# 0 "" 2
#NO_APP
.LBB92:
...
#APP
	# 363 "D:/PrjCoreDalCMake/prjcoredalcmake/deps/core/Os/FreeRTOS/timers.c" 1
	disable
	# 0 "" 2
#NO_APP
.LBB97:
...
#APP
	# 395 "D:/PrjCoreDalCMake/prjcoredalcmake/deps/core/Os/FreeRTOS/timers.c" 1
	disable
	# 0 "" 2
#NO_APP
.LBB102:
...
#APP
	# 437 "D:/PrjCoreDalCMake/prjcoredalcmake/deps/core/Os/FreeRTOS/timers.c" 1
	disable
	# 0 "" 2
#NO_APP
.LBB107:
...
#APP
	# 446 "D:/PrjCoreDalCMake/prjcoredalcmake/deps/core/Os/FreeRTOS/timers.c" 1
	disable
	# 0 "" 2
#NO_APP
.LBB112:
...
#APP
	# 456 "D:/PrjCoreDalCMake/prjcoredalcmake/deps/core/Os/FreeRTOS/timers.c" 1
	disable
	# 0 "" 2
#NO_APP
.LBB117:
...
#APP
	# 477 "D:/PrjCoreDalCMake/prjcoredalcmake/deps/core/Os/FreeRTOS/timers.c" 1
	disable
	# 0 "" 2
#NO_APP
.LBB122:
...
#APP
	# 502 "D:/PrjCoreDalCMake/prjcoredalcmake/deps/core/Os/FreeRTOS/timers.c" 1
	disable
	# 0 "" 2
#NO_APP
.LBB127:
...
#APP
	# 512 "D:/PrjCoreDalCMake/prjcoredalcmake/deps/core/Os/FreeRTOS/timers.c" 1
	disable
	# 0 "" 2
#NO_APP
.LBB132:
...
.LCFI11:
	...
	st.w	[%a14] -16, %d5
	.loc 1 539 0
	movh	%d15, hi:pxCurrentTimerList
	addi	%d15, %d15, lo:pxCurrentTimerList
	mov.a	%a15, %d15
	ld.w	%d15, [%a15]0
	mov.a	%a15, %d15
	ld.w	%d15, [%a15] 12
...
.L64:
	...
	jz	%d15, .L66
	.loc 1 634 0
	movh	%d15, hi:pxOverflowTimerList
	addi	%d15, %d15, lo:pxOverflowTimerList
	mov.a	%a15, %d15
	ld.w	%d15, [%a15]0
	mov.a	%a15, %d15
	ld.w	%d15, [%a15]0
...
.L66:
	...
	.loc 1 645 0
#APP
	# 645 "D:/PrjCoreDalCMake/prjcoredalcmake/deps/core/Os/FreeRTOS/timers.c" 1
	syscall 0
	# 0 "" 2
#NO_APP
	j	.L62
...
.L72:
	...
	mov.a	%a15, %d15
	st.w	[%a15]0, %d2
	.loc 1 674 0 is_stmt 1 discriminator 4
	ld.w	%d15, [%a14] -12
	mov.a	%a15, %d15
	ld.w	%d15, [%a15]0
	jnz	%d15, .L73
...
.LCFI15:
	...
	st.w	[%a14] -4, %d2
	.loc 1 695 0
	movh	%d15, hi:xLastTime.9936
	addi	%d15, %d15, lo:xLastTime.9936
	mov.a	%a15, %d15
	ld.w	%d15, [%a15]0
	ld.w	%d2, [%a14] -4
	jge.u	%d2, %d15, .L77
...
#APP
	# 857 "D:/PrjCoreDalCMake/prjcoredalcmake/deps/core/Os/FreeRTOS/timers.c" 1
	disable
	# 0 "" 2
#NO_APP
.LBB137:
...
.LCFI19:
	...
	jnz	%d15, .L107
	.loc 1 937 0
	movh	%d15, hi:xActiveTimerList1
	mov.a	%a15, %d15
	lea	%a4, [%a15] lo:xActiveTimerList1
	call	vListInitialise
	.loc 1 938 0
	movh	%d15, hi:xActiveTimerList2
	mov.a	%a15, %d15
	lea	%a4, [%a15] lo:xActiveTimerList2
	call	vListInitialise
	.loc 1 939 0
	movh	%d15, hi:pxCurrentTimerList
	addi	%d15, %d15, lo:pxCurrentTimerList
	movh	%d2, hi:xActiveTimerList1
	addi	%d2, %d2, lo:xActiveTimerList1
	mov.a	%a15, %d15
	st.w	[%a15]0, %d2
	.loc 1 940 0
	movh	%d15, hi:pxOverflowTimerList
	addi	%d15, %d15, lo:pxOverflowTimerList
	movh	%d2, hi:xActiveTimerList2
	addi	%d2, %d2, lo:xActiveTimerList2
	mov.a	%a15, %d15
	st.w	[%a15]0, %d2
.LBB141:
	.loc 1 949 0
	mov	%d4, 5
	mov	%d5, 12
	movh	%d15, hi:ucStaticTimerQueueStorage.9982
	mov.a	%a15, %d15
	lea	%a4, [%a15] lo:ucStaticTimerQueueStorage.9982
	movh	%d15, hi:xStaticTimerQueue.9981
	mov.a	%a15, %d15
	lea	%a5, [%a15] lo:xStaticTimerQueue.9981
	mov	%d6, 0
...
#APP
	# 984 "D:/PrjCoreDalCMake/prjcoredalcmake/deps/core/Os/FreeRTOS/timers.c" 1
	disable
	# 0 "" 2
#NO_APP
.LBB143:
...
#APP
	# 1009 "D:/PrjCoreDalCMake/prjcoredalcmake/deps/core/Os/FreeRTOS/timers.c" 1
	disable
	# 0 "" 2
#NO_APP
.LBB148:
...
#APP
	# 1026 "D:/PrjCoreDalCMake/prjcoredalcmake/deps/core/Os/FreeRTOS/timers.c" 1
	disable
	# 0 "" 2
#NO_APP
.LBB153:
...
.LFE261:
	...
	.local	xLastTime.9936
.section .bss,"aw",@nobits
	.align 2
	.type		 xLastTime.9936,@object
	.size		 xLastTime.9936,4
xLastTime.9936:
	.space	4
	.local	ucStaticTimerQueueStorage.9982
	.align 0
	.type		 ucStaticTimerQueueStorage.9982,@object
	.size		 ucStaticTimerQueueStorage.9982,60
ucStaticTimerQueueStorage.9982:
	.space	60
	.local	xStaticTimerQueue.9981
	.align 2
	.type		 xStaticTimerQueue.9981,@object
	.size		 xStaticTimerQueue.9981,80
xStaticTimerQueue.9981:
	.space	80
...
.section .text,"ax",@progbits
.Letext0:
	.file 3 "c:\\hightec\\toolchains\\tricore\\v4.9.3.0\\tricore\\include\\yvals.h"
	.file 4 "c:\\hightec\\toolchains\\tricore\\v4.9.3.0\\tricore\\include\\stdlib.h"
	.file 5 "c:\\hightec\\toolchains\\tricore\\v4.9.3.0\\tricore\\include\\stdint.h"
	.file 6 "D:/PrjCoreDalCMake/prjcoredalcmake/deps/core/Os/FreeRTOS/include/projdefs.h"
	...
	.file 9 "D:/PrjCoreDalCMake/prjcoredalcmake/deps/dal/tc36x/Libraries/iLLD/TC36A/Tricore/_Impl/IfxCpu_cfg.h"
	.file 10 "D:/PrjCoreDalCMake/prjcoredalcmake/deps/dal/tc36x/Libraries/iLLD/TC36A/Tricore/Scu/Std/IfxScuCcu.h"
	.file 11 "D:/PrjCoreDalCMake/prjcoredalcmake/deps/core/Os/FreeRTOS/portable/GCC/tricore_tc36x/portmacro.h"
	.file 12 "D:/PrjCoreDalCMake/prjcoredalcmake/deps/core/Os/FreeRTOS/include/FreeRTOS.h"
	.file 13 "D:/PrjCoreDalCMake/prjcoredalcmake/deps/core/Os/FreeRTOS/include/list.h"
	.file 14 "D:/PrjCoreDalCMake/prjcoredalcmake/deps/core/Os/FreeRTOS/include/task.h"
	.file 15 "D:/PrjCoreDalCMake/prjcoredalcmake/deps/core/Os/FreeRTOS/include/queue.h"
	.file 16 "D:/PrjCoreDalCMake/prjcoredalcmake/deps/core/Os/FreeRTOS/include/timers.h"
...
.Ldebug_info0:
	...
	.byte	0x1
	.string	"D:/PrjCoreDalCMake/prjcoredalcmake/deps/core/Os/FreeRTOS/timers.c"
	...
	.byte	0x5
	.byte	0x3
	.uaword	ucStaticTimerQueueStorage.9982
	.byte	0
	.byte	0
	.uleb128 0x12
	.uaword	0x1c8
...
.Ldebug_macro0:
	...
	.uleb128 0xef
	.string	"__ELF__ 1"
	.file 17 "c:\\hightec\\toolchains\\tricore\\v4.9.3.0\\tricore\\include\\stdc-predef.h"
	.byte	0x3
	.uleb128 0x1
	.uleb128 0x11
	.byte	0x7
	...
	.uleb128 0x5
	.uleb128 0x3
	.file 18 "c:\\hightec\\toolchains\\tricore\\v4.9.3.0\\tricore\\include\\xkeycheck.h"
	.byte	0x3
	.uleb128 0x3
	.uleb128 0x12
	.byte	0x1
	...
	.file 19 "c:\\hightec\\toolchains\\tricore\\v4.9.3.0\\tricore\\include\\stdarg.h"
	.byte	0x3
	.uleb128 0x3a3
	.uleb128 0x13
	.byte	0x7
	...
	.file 20 "c:\\hightec\\toolchains\\tricore\\v4.9.3.0\\tricore\\include\\stddef.h"
	.byte	0x3
	.uleb128 0x23
	.uleb128 0x14
	.byte	0x7
	...
	.byte	0x4
	.file 21 "D:/PrjCoreDalCMake/prjcoredalcmake/config/FreeRTOS/FreeRTOSConfig.h"
	.byte	0x3
	.uleb128 0x3b
	.uleb128 0x15
	.byte	0x7
	...
	.file 31 "c:\\hightec\\toolchains\\tricore\\v4.9.3.0\\tricore\\include\\machine\\intrinsics.h"
	.byte	0x3
	.uleb128 0x3b
	.uleb128 0x1f
	.byte	0x7
	...
	.byte	0x4
	.file 32 "D:/PrjCoreDalCMake/prjcoredalcmake/deps/dal/tc36x/Libraries/Infra/Sfr/TC36A/_Reg/IfxCpu_reg.h"
	.byte	0x3
	.uleb128 0x39
	.uleb128 0x20
	.byte	0x1
	...
	.file 33 "D:/PrjCoreDalCMake/prjcoredalcmake/deps/dal/tc36x/Libraries/Infra/Sfr/TC36A/_Reg/IfxCpu_regdef.h"
	.byte	0x3
	.uleb128 0x3b
	.uleb128 0x21
	.byte	0x1
	...
	.file 34 "D:/PrjCoreDalCMake/prjcoredalcmake/deps/dal/tc36x/Libraries/Infra/Sfr/TC36A/_Reg/Ifx_TypesReg.h"
	.byte	0x3
	.uleb128 0x39
	.uleb128 0x22
	.byte	0x7
	...
	.file 40 "D:/PrjCoreDalCMake/prjcoredalcmake/deps/dal/tc36x/Libraries/Infra/Sfr/TC36A/_Reg/IfxStm_regdef.h"
	.byte	0x3
	.uleb128 0x3b
	.uleb128 0x28
	.byte	0x1
	...
	.byte	0x4
	.file 41 "D:/PrjCoreDalCMake/prjcoredalcmake/deps/dal/tc36x/Libraries/iLLD/TC36A/Tricore/_Impl/IfxScu_cfg.h"
	.byte	0x3
	.uleb128 0x47
	.uleb128 0x29
	.byte	0x1
	.uleb128 0x32
	.string	"IFXSCU_CFG_H "
	.file 42 "D:/PrjCoreDalCMake/prjcoredalcmake/deps/dal/tc36x/Libraries/Infra/Sfr/TC36A/_Reg/IfxScu_bf.h"
	.byte	0x3
	.uleb128 0x35
	.uleb128 0x2a
	.byte	0x7
	...
	.byte	0x4
	.file 43 "D:/PrjCoreDalCMake/prjcoredalcmake/deps/dal/tc36x/Libraries/Service/CpuGeneric/_Utilities/Ifx_Assert.h"
	.byte	0x3
	.uleb128 0x48
	.uleb128 0x2b
	.byte	0x1
	...
	.byte	0x4
	.file 44 "D:/PrjCoreDalCMake/prjcoredalcmake/deps/dal/tc36x/Libraries/iLLD/TC36A/Tricore/Scu/Std/IfxScuWdt.h"
	.byte	0x3
	.uleb128 0x49
	.uleb128 0x2c
	.byte	0x1
	...
	.file 45 "D:/PrjCoreDalCMake/prjcoredalcmake/deps/dal/tc36x/Libraries/iLLD/TC36A/Tricore/Scu/Std/IfxScuWdt.asm.h"
	.byte	0x3
	.uleb128 0x43
	.uleb128 0x2d
	.byte	0x7
	...
	.byte	0x1
	.uleb128 0x3c
	.string	"tmrNO_DELAY ( ( TickType_t ) 0U )"
	.byte	0x1
	.uleb128 0x3d
	.string	"tmrMAX_TIME_BEFORE_OVERFLOW ( ( TickType_t ) -1 )"
	.byte	0x1
	.uleb128 0x42
	.string	"configTIMER_SERVICE_TASK_NAME \"Tmr Svc\""
	.byte	0x1
	.uleb128 0x46
	.string	"tmrSTATUS_IS_ACTIVE ( ( uint8_t ) 0x01 )"
	.byte	0x1
	.uleb128 0x47
	.string	"tmrSTATUS_IS_STATICALLY_ALLOCATED ( ( uint8_t ) 0x02 )"
	.byte	0x1
	.uleb128 0x48
	.string	"tmrSTATUS_IS_AUTORELOAD ( ( uint8_t ) 0x04 )"
	.byte	0x4
	.byte	0
...
.Ldebug_macro46:
	...
	.byte	0
.section .debug_macro,"G",@progbits,wm4.timers.h.31.66ebcd2d44a2c3d69f2bf78390c55c74,comdat
.Ldebug_macro47:
	.uahalf	0x4
	.byte	0
	.byte	0x1
	...
	.byte	0x1
	.uleb128 0x39
	.string	"tmrCOMMAND_EXECUTE_CALLBACK_FROM_ISR ( ( BaseType_t ) -2 )"
	.byte	0x1
	.uleb128 0x3a
	.string	"tmrCOMMAND_EXECUTE_CALLBACK ( ( BaseType_t ) -1 )"
	.byte	0x1
	.uleb128 0x3b
	.string	"tmrCOMMAND_START_DONT_TRACE ( ( BaseType_t ) 0 )"
	.byte	0x1
	.uleb128 0x3c
	.string	"tmrCOMMAND_START ( ( BaseType_t ) 1 )"
	.byte	0x1
	.uleb128 0x3d
	.string	"tmrCOMMAND_RESET ( ( BaseType_t ) 2 )"
	.byte	0x1
	.uleb128 0x3e
	.string	"tmrCOMMAND_STOP ( ( BaseType_t ) 3 )"
	.byte	0x1
	.uleb128 0x3f
	.string	"tmrCOMMAND_CHANGE_PERIOD ( ( BaseType_t ) 4 )"
	.byte	0x1
	.uleb128 0x40
	.string	"tmrCOMMAND_DELETE ( ( BaseType_t ) 5 )"
	.byte	0x1
	.uleb128 0x42
	.string	"tmrFIRST_FROM_ISR_COMMAND ( ( BaseType_t ) 6 )"
	.byte	0x1
	.uleb128 0x43
	.string	"tmrCOMMAND_START_FROM_ISR ( ( BaseType_t ) 6 )"
	.byte	0x1
	.uleb128 0x44
	.string	"tmrCOMMAND_RESET_FROM_ISR ( ( BaseType_t ) 7 )"
	.byte	0x1
	.uleb128 0x45
	.string	"tmrCOMMAND_STOP_FROM_ISR ( ( BaseType_t ) 8 )"
	.byte	0x1
	.uleb128 0x46
	.string	"tmrCOMMAND_CHANGE_PERIOD_FROM_ISR ( ( BaseType_t ) 9 )"
	.byte	0x1
	.uleb128 0x1fd
	.string	"xTimerStart(xTimer,xTicksToWait) xTimerGenericCommand( ( xTimer ), tmrCOMMAND_START, ( xTaskGetTickCount() ), NULL, ( xTicksToWait ) )"
	.byte	0x1
	.uleb128 0x228
	.string	"xTimerStop(xTimer,xTicksToWait) xTimerGenericCommand( ( xTimer ), tmrCOMMAND_STOP, 0U, NULL, ( xTicksToWait ) )"
	.byte	0x1
	.uleb128 0x279
	.string	"xTimerChangePeriod(xTimer,xNewPeriod,xTicksToWait) xTimerGenericCommand( ( xTimer ), tmrCOMMAND_CHANGE_PERIOD, ( xNewPeriod ), NULL, ( xTicksToWait ) )"
	.byte	0x1
	.uleb128 0x2a0
	.string	"xTimerDelete(xTimer,xTicksToWait) xTimerGenericCommand( ( xTimer ), tmrCOMMAND_DELETE, 0U, NULL, ( xTicksToWait ) )"
	.byte	0x1
	.uleb128 0x31d
	.string	"xTimerReset(xTimer,xTicksToWait) xTimerGenericCommand( ( xTimer ), tmrCOMMAND_RESET, ( xTaskGetTickCount() ), NULL, ( xTicksToWait ) )"
	.byte	0x1
	.uleb128 0x374
	.string	"xTimerStartFromISR(xTimer,pxHigherPriorityTaskWoken) xTimerGenericCommand( ( xTimer ), tmrCOMMAND_START_FROM_ISR, ( xTaskGetTickCountFromISR() ), ( pxHigherPriorityTaskWoken ), 0U )"
	.byte	0x1
	.uleb128 0x3b4
	.string	"xTimerStopFromISR(xTimer,pxHigherPriorityTaskWoken) xTimerGenericCommand( ( xTimer ), tmrCOMMAND_STOP_FROM_ISR, 0, ( pxHigherPriorityTaskWoken ), 0U )"
	.byte	0x1
	.uleb128 0x3fe
	.string	"xTimerChangePeriodFromISR(xTimer,xNewPeriod,pxHigherPriorityTaskWoken) xTimerGenericCommand( ( xTimer ), tmrCOMMAND_CHANGE_PERIOD_FROM_ISR, ( xNewPeriod ), ( pxHigherPriorityTaskWoken ), 0U )"
	.byte	0x1
	.uleb128 0x455
	.string	"xTimerResetFromISR(xTimer,pxHigherPriorityTaskWoken) xTimerGenericCommand( ( xTimer ), tmrCOMMAND_RESET_FROM_ISR, ( xTaskGetTickCountFromISR() ), ( pxHigherPriorityTaskWoken ), 0U )"
	.byte	0
...
.LASF20:
	.string	"xMessage"
	.extern	xQueueGenericCreateStatic,STT_FUNC,0
	.extern	vListInitialise,STT_FUNC,0
	.extern	xQueueReceive,STT_FUNC,0
	.extern	vListInsert,STT_FUNC,0
	.extern	xTaskGetTickCount,STT_FUNC,0
	.extern	vQueueWaitForMessageRestricted,STT_FUNC,0
	.extern	xTaskResumeAll,STT_FUNC,0
	.extern	vTaskSuspendAll,STT_FUNC,0
	.extern	uxListRemove,STT_FUNC,0
	.extern	vTaskExitCritical,STT_FUNC,0
	.extern	vTaskEnterCritical,STT_FUNC,0
	.extern	xQueueGenericSendFromISR,STT_FUNC,0
	.extern	xQueueGenericSend,STT_FUNC,0
	.extern	xTaskGetSchedulerState,STT_FUNC,0
	.extern	vListInitialiseItem,STT_FUNC,0
	.extern	xTaskCreateStatic,STT_FUNC,0
	.extern	vApplicationGetTimerTaskMemory,STT_FUNC,0
