# 1 "D:/PrjCoreDalCMake/prjcoredalcmake/deps/core/Os/FreeRTOS/timers.c"
...
# 1 "<command-line>" 2
# 1 "D:/PrjCoreDalCMake/prjcoredalcmake/deps/core/Os/FreeRTOS/timers.c"
# 30 "D:/PrjCoreDalCMake/prjcoredalcmake/deps/core/Os/FreeRTOS/timers.c"
...
# 31 "D:/PrjCoreDalCMake/prjcoredalcmake/deps/core/Os/FreeRTOS/timers.c" 2
...
# 38 "D:/PrjCoreDalCMake/prjcoredalcmake/deps/core/Os/FreeRTOS/timers.c" 2
...
# 39 "D:/PrjCoreDalCMake/prjcoredalcmake/deps/core/Os/FreeRTOS/timers.c" 2
...
# 40 "D:/PrjCoreDalCMake/prjcoredalcmake/deps/core/Os/FreeRTOS/timers.c" 2
...
# 41 "D:/PrjCoreDalCMake/prjcoredalcmake/deps/core/Os/FreeRTOS/timers.c" 2
# 50 "D:/PrjCoreDalCMake/prjcoredalcmake/deps/core/Os/FreeRTOS/timers.c"
#undef MPU_WRAPPERS_INCLUDED_FROM_API_FILE
# 60 "D:/PrjCoreDalCMake/prjcoredalcmake/deps/core/Os/FreeRTOS/timers.c"
...
# 137 "D:/PrjCoreDalCMake/prjcoredalcmake/deps/core/Os/FreeRTOS/timers.c"
...
# 154 "D:/PrjCoreDalCMake/prjcoredalcmake/deps/core/Os/FreeRTOS/timers.c"
...
# 275 "D:/PrjCoreDalCMake/prjcoredalcmake/deps/core/Os/FreeRTOS/timers.c"
        }
        else
        {
            ;
        ...
        if( ( xReturn ) == 0 ) { { uint32_t ulICR; __asm__ volatile ("disable" : : : "memory"); ulICR = (__extension__({ unsigned __res; __asm__ volatile ("mfcr %0, LO:" "0xFE2C" : "=d" (__res) :: "memory"); __res; })); ulICR &= ~( 0x000000FFUL ); ulICR |= 64; do { unsigned __newval = (unsigned) (ulICR); __asm__ volatile ("mtcr LO:" "0xFE2C" ", %0" :: "d" (__newval) : "memory"); } while (0); Ifx__isync(); __asm__ volatile ("enable" : : : "memory"); }; for( ;; ); };
        return xReturn;
    }
# 315 "D:/PrjCoreDalCMake/prjcoredalcmake/deps/core/Os/FreeRTOS/timers.c"
        TimerHandle_t xTimerCreateStatic( const char * const pcTimerName,
                                          const TickType_t xTimerPeriodInTicks,
                                          const UBaseType_t uxAutoReload,
                                          void * const pvTimerID,
                                          ...
                                          StaticTimer_t * pxTimerBuffer )
        {
            Timer_t * pxNewTimer;
...

                {
                    ...
                    if( ( xSize == sizeof( Timer_t ) ) == 0 ) { { uint32_t ulICR; __asm__ volatile ("disable" : : : "memory"); ulICR = (__extension__({ unsigned __res; __asm__ volatile ("mfcr %0, LO:" "0xFE2C" : "=d" (__res) :: "memory"); __res; })); ulICR &= ~( 0x000000FFUL ); ulICR |= 64; do { unsigned __newval = (unsigned) (ulICR); __asm__ volatile ("mtcr LO:" "0xFE2C" ", %0" :: "d" (__newval) : "memory"); } while (0); Ifx__isync(); __asm__ volatile ("enable" : : : "memory"); }; for( ;; ); };
                    ( void ) xSize;
                }



            if( ( pxTimerBuffer ) == 0 ) { { uint32_t ulICR; __asm__ volatile ("disable" : : : "memory"); ulICR = (__extension__({ unsigned __res; __asm__ volatile ("mfcr %0, LO:" "0xFE2C" : "=d" (__res) :: "memory"); __res; })); ulICR &= ~( 0x000000FFUL ); ulICR |= 64; do { unsigned __newval = (unsigned) (ulICR); __asm__ volatile ("mtcr LO:" "0xFE2C" ", %0" :: "d" (__newval) : "memory"); } while (0); Ifx__isync(); __asm__ volatile ("enable" : : : "memory"); }; for( ;; ); };
                                       ...
                                       Timer_t * pxNewTimer )
    {
        ...
        if( ( ( xTimerPeriodInTicks > 0 ) ) == 0 ) { { uint32_t ulICR; __asm__ volatile ("disable" : : : "memory"); ulICR = (__extension__({ unsigned __res; __asm__ volatile ("mfcr %0, LO:" "0xFE2C" : "=d" (__res) :: "memory"); __res; })); ulICR &= ~( 0x000000FFUL ); ulICR |= 64; do { unsigned __newval = (unsigned) (ulICR); __asm__ volatile ("mtcr LO:" "0xFE2C" ", %0" :: "d" (__newval) : "memory"); } while (0); Ifx__isync(); __asm__ volatile ("enable" : : : "memory"); }; for( ;; ); };
                                     ...
                                     const TickType_t xTicksToWait )
    {
        ...
        if( ( xTimer ) == 0 ) { { uint32_t ulICR; __asm__ volatile ("disable" : : : "memory"); ulICR = (__extension__({ unsigned __res; __asm__ volatile ("mfcr %0, LO:" "0xFE2C" : "=d" (__res) :: "memory"); __res; })); ulICR &= ~( 0x000000FFUL ); ulICR |= 64; do { unsigned __newval = (unsigned) (ulICR); __asm__ volatile ("mtcr LO:" "0xFE2C" ", %0" :: "d" (__newval) : "memory"); } while (0); Ifx__isync(); __asm__ volatile ("enable" : : : "memory"); }; for( ;; ); };
    ...
    TaskHandle_t xTimerGetTimerDaemonTaskHandle( void )
    {
        ...
        if( ( ( xTimerTaskHandle != ((void *)0) ) ) == 0 ) { { uint32_t ulICR; __asm__ volatile ("disable" : : : "memory"); ulICR = (__extension__({ unsigned __res; __asm__ volatile ("mfcr %0, LO:" "0xFE2C" : "=d" (__res) :: "memory"); __res; })); ulICR &= ~( 0x000000FFUL ); ulICR |= 64; do { unsigned __newval = (unsigned) (ulICR); __asm__ volatile ("mtcr LO:" "0xFE2C" ", %0" :: "d" (__newval) : "memory"); } while (0); Ifx__isync(); __asm__ volatile ("enable" : : : "memory"); }; for( ;; ); };
    ...
    static void prvTimerTask( void *pvParameters )
    {
        ...
        ( void ) pvParameters;
# 583 "D:/PrjCoreDalCMake/prjcoredalcmake/deps/core/Os/FreeRTOS/timers.c"
        for( ; ; )
        {
    ...
    {
        TickType_t xNextExpireTime;
# 672 "D:/PrjCoreDalCMake/prjcoredalcmake/deps/core/Os/FreeRTOS/timers.c"
    ...
    static void prvProcessReceivedCommands( void )
    {
        ...
        {
# 788 "D:/PrjCoreDalCMake/prjcoredalcmake/deps/core/Os/FreeRTOS/timers.c"
            if( xMessage.xMessageID >= ( BaseType_t ) 0 )
            {
                ...
                switch( xMessage.xMessageID )
                {
                    ...
                    case ( ( BaseType_t ) 5 ):
# 884 "D:/PrjCoreDalCMake/prjcoredalcmake/deps/core/Os/FreeRTOS/timers.c"
                            {
...
# 969 "D:/PrjCoreDalCMake/prjcoredalcmake/deps/core/Os/FreeRTOS/timers.c"
            }
            else
            {
                ;
...
# 1097 "D:/PrjCoreDalCMake/prjcoredalcmake/deps/core/Os/FreeRTOS/timers.c"
        UBaseType_t uxTimerGetTimerNumber( TimerHandle_t xTimer )
        {
