# 1 "D:/PrjCoreDalCMake/prjcoredalcmake/deps/dal/tc36x/Libraries/Infra/Ssw/TC36A/Tricore/Ifx_Ssw_Infra.c"
...
# 1 "<command-line>" 2
# 1 "D:/PrjCoreDalCMake/prjcoredalcmake/deps/dal/tc36x/Libraries/Infra/Ssw/TC36A/Tricore/Ifx_Ssw_Infra.c"
# 41 "D:/PrjCoreDalCMake/prjcoredalcmake/deps/dal/tc36x/Libraries/Infra/Ssw/TC36A/Tricore/Ifx_Ssw_Infra.c"
...
# 42 "D:/PrjCoreDalCMake/prjcoredalcmake/deps/dal/tc36x/Libraries/Infra/Ssw/TC36A/Tricore/Ifx_Ssw_Infra.c" 2
...
# 46 "D:/PrjCoreDalCMake/prjcoredalcmake/deps/dal/tc36x/Libraries/Infra/Ssw/TC36A/Tricore/Ifx_Ssw_Infra.h" 2
...
# 43 "D:/PrjCoreDalCMake/prjcoredalcmake/deps/dal/tc36x/Libraries/Infra/Ssw/TC36A/Tricore/Ifx_Ssw_Infra.c" 2
...
void Ifx_Ssw_disableCpuWatchdog(Ifx_SCU_WDTCPU *watchdog, unsigned short password)
{
    ...
    cpuIndex = (__extension__({ unsigned __res; __asm__ volatile ("mfcr %0, LO:" "0xFE1C" : "=d" (__res) :: "memory"); __res; }));;
    cpuIndex = (unsigned int)((unsigned int)cpuIndex >> (0u)) & (0x7u);
    cpuIndex = Ifx_Ssw_MINU(cpuIndex, 5);
    Ifx_SCU_WDTCPU *wdt = &((*(Ifx_SCU*)0xF0036000u)).WDTCPU[cpuIndex];
...
void Ifx_Ssw_disableSafetyWatchdog(unsigned short password)
{
    ...
    (*(volatile Ifx_SCU_WDTS_CON1*)0xF00362ACu).B.DR = 1U;
...
{
    Ifx_Ssw_clearSafetyEndinit(password);
    (*(volatile Ifx_SCU_WDTS_CON1*)0xF00362ACu).B.DR = 0U;
    Ifx_Ssw_setSafetyEndinit(password);
}
...
{
    Ifx_SCU_WDTCPU *wdt = &((*(Ifx_SCU*)0xF0036000u)).WDTCPU[0];
    unsigned short cpuWdtPw = Ifx_Ssw_getCpuWatchdogPassword(wdt);
    Ifx_Ssw_clearCpuEndinit(wdt, cpuWdtPw);
    (*(volatile Ifx_SCU_PMCSR0*)0xF00360C8u).B.REQSLP = 1U;
...
{
    float oscFreq = ((20000000));
    float sourcefreq = (100000000.0);
    unsigned int insel = (*(volatile Ifx_SCU_SYSPLLCON0*)0xF0036018u).B.INSEL;
    ...
    if ((*(volatile Ifx_SCU_CCUCON0*)0xF0036030u).B.CLKSEL != 0U)
    {
        sourcefreq = (oscFreq * ((*(volatile Ifx_SCU_SYSPLLCON0*)0xF0036018u).B.NDIV + 1U)) /
                     (((*(volatile Ifx_SCU_SYSPLLCON0*)0xF0036018u).B.PDIV + 1U) * ((*(volatile Ifx_SCU_SYSPLLCON1*)0xF003601Cu).B.K2DIV + 1U));
    }

    return sourcefreq / (*(volatile Ifx_SCU_CCUCON0*)0xF0036030u).B.STMDIV;
}
...
#pragma GCC optimize "O2"
# 296 "D:/PrjCoreDalCMake/prjcoredalcmake/deps/dal/tc36x/Libraries/Infra/Ssw/TC36A/Tricore/Ifx_Ssw_Infra.c"
#pragma GCC reset_options
